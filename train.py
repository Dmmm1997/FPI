...
def get_parse():
    ...
    parser.add_argument('--train_dir', default='/home/dmmm/Dataset/FPI/FPI2022/map2019/train', type=str, help='training dir path')
    parser.add_argument('--val_dir', default='/home/dmmm/Dataset/FPI/FPI2022/map2019/val', type=str, help='training dir path')
    ...
    parser.add_argument('--save_epochs', default=14, type=int, help='')
    ...
    parser.add_argument('--backbone', default="pvt_small", type=str, help='')
    parser.add_argument('--neck', default="FPN", type=str, help='')
    ...
    parser.add_argument('--steps', default=[15], type=int, help='the times of padding for the image size')
...
def train_model(model, opt,  dataloaders, dataset_sizes):
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % opt.save_epochs == 0 and (epoch+1)>=opt.epoch_start_save:
